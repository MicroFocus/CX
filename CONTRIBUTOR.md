...
*   (c) If the contribution includes any open source or commercial code, those components have been registered and approved in ITLS (http://alliance.microfocus.com/RegistrationList.aspx).
